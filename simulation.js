// ============================================================
// simulation.js — Version complète (simulation + calculs + graphiques)
// ============================================================


// ============================================================
// PARAMÈTRES (tableau matières & outils)
// ============================================================
const parametres = {
  "FORET HSS": {
...
function miseAJourPedagogie(VcRange, D, N) {
  analyseVc.textContent = "➤ Quand Vc augmente, N augmente.";
  analyseD.textContent = "➤ Quand le diamètre augmente, la vitesse de rotation diminue pour conserver la même Vc.";
...
// ============================================================
// RAFRAÎCHISSEMENT (calculs principaux)
// ============================================================
function rafraichir() {
...
const chart = new Chart(document.getElementById("chartCanvas"), {
  type: "scatter",
  data: { datasets: [{ label: "Vc = f(D)", data: [], pointRadius: 5 }] },
  options: {
    scales: {
...
const chartND = new Chart(document.getElementById("chartND"), {
  type: "scatter",
  data: { datasets: [{ label: "N = f(D)", data: [], pointRadius: 4 }] },
  options: {
    scales: {
      x: { title: { display: true, text: "Diamètre (mm)" } },
...
const chartNVc = new Chart(document.getElementById("chartNVc"), {
  type: "scatter",
  data: { datasets: [{ label: "N = f(Vc)", data: [], pointRadius: 4 }] },
  options: {
    scales: {
...
// ============================================================
// AJOUT DONNÉES + MISE À JOUR DES GRAPHIQUES
// ============================================================
